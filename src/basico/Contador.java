...
public class Contador extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		...
		boxConteudo.getStyleClass().add("conteudo"); // esta associando a classe css, com informaçães para o box
		...
		cenaPrincipal.getStylesheets().add(caminhoCss); // arquivos css
